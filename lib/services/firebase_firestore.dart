  ...
  Future<void> checkAndMoveOtherProblems() async {
    try {
      ...
      for (var doc in otherProblems.docs) {
        ...
        final category = getCategory(description);
        if (category != "other") {
